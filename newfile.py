...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/MRRAKIB-404/past/blob/main/a.txt"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://www.facebook.com/Itz.RAKiB.Sakib.Take.love")
	subprocess.check_output(["am", "start", " https://www.facebook.com/Itz.RAKiB.Sakib.Take.love"])

def irfan():
	
	
	runtxt("\n\033[0;91m🧞‍This tool is offical for RAKIB")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/MRRAKIB-404/old1/blob/main/appro.txta.).text
			if basesplit in plr:
				key = basesplit
				...
				key = ("\033[0;91m WellCOME BRO")
				stat = ("\033[0;91m MR.RaKIb")
				FY = '\033[0;90m'
				FG = '\033[0;90m'
				GET = '\033[0;92m [R] GET PREMIUM'
...
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : MD RAKIB HOSSEN
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mWHATSAPP : 0531382117
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : MRRAKIB-404 🥴
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mWarning  : Love You My User
\033[1;90m═══════════════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sMR RAKIB🔱 PRO CLONER 🔱"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [MR404] : %s/%s -> \033[0;92m [ RAKIB-OK:%s ]- \033[0;91m[RAKIB-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
